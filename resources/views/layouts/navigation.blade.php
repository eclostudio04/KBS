            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <img src="{{ asset('img/KBSBW - Transparent.webp') }}" alt="logo"
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @role('owner')
                        ...
                        {{-- navigasi fundraising_withdrawals --}}
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button
                            ...
                            <div class="flex flex-row items-center gap-x-5"><img class="w-[35px] h-[35px] "
