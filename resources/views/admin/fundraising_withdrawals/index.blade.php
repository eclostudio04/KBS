    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                ...
                @forelse ($fundraising_withdrawals as $withdrawal)
                    <div class="item-card flex flex-row justify-between items-center">
                        ...
                        <div>
                            ...
                            <h3 class="text-indigo-950 text-xl font-bold">Rp
                                {{ number_format($withdrawal->amount_requested, 0, ',', '.') }}</h3>
                        </div>
                        <div>
                            <p class="text-slate-500 text-sm">Tanggal</p>
                            <h3 class="text-indigo-950 text-xl font-bold">{{ $withdrawal->created_at }}</h3>
                        </div>
                ...
                @empty
                    <p>Belum ada data penarikan terbaru</p>
                @endforelse
