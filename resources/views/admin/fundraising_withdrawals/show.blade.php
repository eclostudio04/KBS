    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                <h3 class="text-indigo-950 text-3xl font-bold mb-5">Permintaan Untuk Penarikan</h3>
                    ...
                    <div class="flex flex-col gap-y-10">
                        <div>
                            ...
                            <h3 class="text-indigo-950 text-xl font-bold">Rp
                                {{ number_format($fundraisingWithdrawal->amount_requested, 0, ',', '.') }}
                            </h3>
                        </div>
                        ...
                        <div>
                            ...
                            <h3 class="text-indigo-950 text-xl font-bold">{{ $fundraisingWithdrawal->created_at }}
                            </h3>
                        </div>
                        <div class="">
                            <p class="text-slate-500 text-sm">Penggalang Dana</p>
                ...
                <hr class="my-5">
                <h3 class="text-indigo-950 text-xl font-bold mb-5">Kirim Dana Ke:</h3>
