<x-app-layout>
    ...
    @role('owner')
        {{-- list ini akan tampil pada halaman owner saja --}}
    ...
    @else
        {{-- list ini akan tampil pada halaman fundraiser saja --}}
        <div class="list-fundraisers py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col ">
                    <div class="item-card flex flex-col justify-between items-center gap-y-5">
                        ...
                        <div class="flex flex-col text-center">
                            ...
                            <p class="text-slate-500 text-base">Jadilah bagian dari kami untuk membantu <br>mereka yang
