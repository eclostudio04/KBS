            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                ...
                @if ($fundraising->is_active)
                    <span class="text-white font-bold bg-green-500 rounded-2xl w-fit p-5">
                        Penggalangan Dana sudah di Setujui
                    </span>
                @else
                    <div class="flex flex-row justify-between">
                        <span class="text-white font-bold bg-red-500 rounded-2xl w-fit p-5">
                            Penggalangan Dana Belum di Setujui oleh Super Admin
                        </span>
                        @role('owner')
                ...
                @if ($goalReached)
                    @if (!$hasRequestedWithdrawal)
                        <hr class="my-5">
                        <h3 class="text-indigo-950 text-2xl font-bold">Tarik Donasi</h3>
                ...
                <div class="flex flex-row justify-between items-center">
                    <div class="flex flex-col">
                        <h3 class="text-indigo-950 text-xl font-bold">Donatur</h3>
                    </div>
                </div>
                ...
                @forelse ($fundraising->donaturs as $donatur)
                    <div class="item-card flex flex-row gap-y-10 justify-between items-center">
                        ...
                        <p class="text-slate-500 text-sm">{{ $donatur->note }}</p>
