            ...
            <div class="header flex flex-col overflow-hidden h-[220px] relative">
                <nav class="pt-5 px-3 flex justify-between items-center relative z-20">
                    ...
                    <div class="flex flex-col items-center text-center">
                        <p class="font-semibold text-sm">#KirimSupport</p>
                    </div>
        ...
        <div class="container w-[500px] lg:p-5 lg:w-[800px] md:w-[630px] justify-center mx-auto">
            <div class="flex flex-col z-30">
                <div id="content"
                    ...
                    <h1 class="text-center font-extrabold text-[24px] leading-[36px]">Pilih Jumlah <br>Anda Ingin Donasikan
                    </h1>
                    <div class="grid grid-cols-2 w-fit mx-auto justify-center gap-[30px]">
                        ...
                        <a href="{{ route('front.checkout', ['fundraising' => $fundraising->slug, 'totalAmountDonation' => 700000]) }}"
                            class="w-[150px] flex flex-col gap-4 p-4 rounded-[30px] border border-[#E8E9EE] items-center">
                            <div class="w-10 h-10 flex shrink-0 overflow-hidden">
                                <img src="{{ asset('assets/images/icons/smile.svg') }}" alt="icon">
                            </div>
