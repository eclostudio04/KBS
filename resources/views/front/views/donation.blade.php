...
@section('content')
    <section
        ...
        <p class="leading-[32px] mt-[30px] text-center">Every penny you gave were impactful for <br> those who might need
            it, thank you.</p>
        <div class="w-[220px] mx-auto flex flex-col gap-5 mt-[50px]">
            <a href="details-finished.html"
                class="p-[14px_20px] bg-[#76AE43] rounded-full text-white w-full mx-auto font-semibold hover:shadow-[0_12px_20px_0_#76AE4380] transition-all duration-300 text-nowrap text-center">View
                Details</a>
            <a href=""
                class="p-[14px_20px] bg-[#1E2037] rounded-full text-white w-full mx-auto font-semibold text-nowrap text-center">Contact
                Our CS</a>
        </div>
    </section>
@endsection
