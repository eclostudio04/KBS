...
@section('content')
    {{-- max-w-[640px] w-full min-h-screen mx-auto flex flex-col bg-white overflow-x-hidden --}}
    <section class="bg-white">
        {{-- header --}}
        <div class="header flex flex-col bg-[#56BBC5] h-[350px] relative -mb-[92px]">
        ...
        <div class="container w-[500px] lg:p-5 lg:w-[800px] md:w-full justify-center mx-auto lg:mt-20 mt-[100px]">
                ...
                <div id="content" class="w-full bg-white rounded-t-[40px] flex flex-col gap-5 p-[30px_24px_120px]">
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <div class="flex items-center justify-between">
                            <p class="text-sm text-[#66697A]">Rp
                                {{ number_format($fundraising->totalReachAmount(), 0, ',', '.') }}
                            </p>
                    ...
                    @forelse ($fundraising->fundraising_phases as $phase)
                        <div class="flex flex-col gap-[10px] p-5 rounded-[20px] bg-[#F6ECE2]">
                            ...
                            <p class="text-sm leading-[26px]">{{ $phase->note }}</p>
                        </div>
                    @empty
                    @endforelse
                    ...
                    <div class="flex flex-col gap-3">
                        <div class="flex items-center justify-between">
                            ...
                            <a href="" class="p-[6px_12px] rounded-full bg-[#E8E9EE] font-semibold text-sm">View
                                All</a>
                        </div>
                        <div class="flex flex-col gap-4">
                            @forelse ($fundraising->donaturs as $donatur)
                                <div class="flex items-center gap-3">
                                    {{-- w-[50px] h-[50px] flex shrink-0 rounded-full overflow-hidden --}}
                                    ...
                                    <div class="flex flex-col gap-[2px] w-full">
                                        <div class="flex items-center justify-between">
                                            ...
                                            <p class="font-semibold text-[10px] leading-[15px] text-right text-[#66697A]">
                                                {{ $donatur->name }}
                                            </p>
                                        </div>
                                        <p class="caption text-xs leading-[18px] text-[#66697A]">“{{ $donatur->note }}”
                                        </p>
                                    </div>
                                </div>
                            @empty
                                <p>Belum ada donatur yang memberi</p>
                            @endforelse
        ...
        {{-- membuat kondisi jika target belum terpenuhi maka masi bisa berdonasi --}}
        {{-- @if (!$goalReached) --}}
