        ...
        <div class="flex flex-col z-30">
            ...
            <div id="content" class="w-full bg-white rounded-t-[40px] flex flex-col gap-5 p-[30px_24px_120px]">
                <div class="flex flex-col gap-[10px]">
                    ...
                    <div class="flex items-center gap-2">
                        <div class="w-9 h-9 flex shrink-0 rounded-full overflow-hidden">
                            <img src="{{ asset('assets/images/photos/photo.png') }}" class="w-full h-full object-cover"
                                alt="photo">
                        </div>
                ...
                <div class="flex flex-col gap-[2px]">
                    ...
                    <p class="desc-less text-sm leading-[26px]">Kebakaran Hutan dan Lahan (Karhutla) yang terjadi di
                        sejumlah titik di wilayah Kalimantan Barat (Kalbar) selama beberapa <button
                            class="text-[#FF7815] underline" onclick="toggleSeeMoreLess()">see more</button></p>
                    <p class="desc-more text-sm leading-[26px] hidden">Kebakaran Hutan dan Lahan (Karhutla) yang terjadi di
                        sejumlah titik di wilayah Kalimantan Barat (Kalbar) selama beberapa Lorem ipsum dolor sit amet,
                        consectetur adipisicing elit. Facilis a earum iure nihil voluptas tenetur. <button
                            class="text-[#FF7815] underline" onclick="toggleSeeMoreLess()">see less</button></p>
                </div>
                    ...
                    <div class="flex flex-col gap-4">
                        <div class="flex items-center gap-3">
                            ...
                            <div class="flex flex-col gap-[2px] w-full">
                                <div class="flex items-center justify-between">
                                    ...
                                    <p class="font-semibold text-[10px] leading-[15px] text-right text-[#66697A]">by Annemi
                                    </p>
                                </div>
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div class="flex flex-col gap-[2px] w-full">
                                ...
                                <p class="caption text-xs leading-[18px] text-[#66697A]">“Jangan lupa berdoa agar lancar”
                                </p>
                            </div>
                        </div>
                        <div class="flex items-center gap-3">
                            ...
                            <div class="flex flex-col gap-[2px] w-full">
                                <div class="flex items-center justify-between">
                                    ...
                                    <p class="font-semibold text-[10px] leading-[15px] text-right text-[#66697A]">by Angga
                                    </p>
                                </div>
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div class="flex flex-col gap-[2px] w-full">
                                ...
                                <p class="caption text-xs leading-[18px] text-[#66697A]">“Ayo semangat pasti kamu bisa!”
                                </p>
                            </div>
                        </div>
                        <div class="flex items-center gap-3">
                            ...
                            <div class="flex flex-col gap-[2px] w-full">
                                <div class="flex items-center justify-between">
                                    ...
                                    <p class="font-semibold text-[10px] leading-[15px] text-right text-[#66697A]">by Shayna
                                    </p>
                                </div>
                                <p class="caption text-xs leading-[18px] text-[#66697A]">“Jangan lupa berdoa agar lancar”
                                </p>
